    ...
    function sideMenuRes() {
      ...
      btnPress.addEventListener("click", () => {
        ...
        if (!menuOpen) {
          ...
          gsap.to(btnPress, { x: isDesktop ? 100 : 0 });
        } else {
...
function sideMenuTextAnim() {
    // Disable this function on screens 767px or smaller
    if (window.innerWidth <= 767) return;

    var touchAreas = document.querySelectorAll(".nav-list-items");

    touchAreas.forEach(function(elem){
...
function sideMenuTextAnim2(){

        // Disable this fuenction on screens 767px or smaller
    if (window.innerWidth <= 767) return

    var touch = document.querySelectorAll(".nav-down-btn-div")
    var upper = document.querySelectorAll(".upper-btn-nav") 
    var lower = document.querySelectorAll(".lower-btn-nav") 
